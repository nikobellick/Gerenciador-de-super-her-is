...
//ScalarAttributeType = tipo de atributo que é passado para o DynamoDB
...
//No DynamoDB não cria a tabela, é passado as informações de configuração da tabela, e depois o restante das colunas passa via post e então cria a tabela. 
//@Configuration
